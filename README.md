...
Please see the current list of [issues](https://github.com/carpentries-incubator/machine-learning-responsible-python/issues) for ideas for contributing to this
